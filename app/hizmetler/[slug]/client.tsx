...
import { ArrowLeft, CheckCircle2, Phone, CalendarCheck, Star, Camera } from 'lucide-react';
...
const serviceData: Record<string, {
  ...
  "dini": { // Slug adını 'dini' olarak düzelttim (generateStaticParams ile eşleşmesi için)
    title: "Hafızlık İcazet & Mevlüt",
    subtitle: "Manevi Atmosferin Huzurla Buluştuğu Anlar",
...
export default function ServiceDetailClient({ slug }: ClientProps) {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                {/* --- GALERİ BUTONU --- */}
                <Link 
                  href={`/galeri?tab=${slug}`}
                  className="w-full border-2 border-amber-500 text-amber-600 py-4 rounded-xl flex items-center justify-center gap-2 font-semibold hover:bg-amber-50 transition-all"
                >
                  <Camera size={20} />
                  Bu Hizmetin Fotoğraflarını İncele
                </Link>
              </div>
